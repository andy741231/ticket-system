...
const submit = () => {
    form.post(route('directory.store'));
};
...
<template>
  ...
  <AuthenticatedLayout>
    <template #header>
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Add New Team Member</h2>
    </template>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="md:col-span-1 flex flex-col items-center">
                            <div class="relative group">
                                <img v-if="form.img" :src="form.img" alt="Profile preview" class="rounded-full h-48 w-48 object-cover">
                        ...
                        <div class="md:col-span-2 space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <TextInput id="email" type="email" class="dark:bg-gray-700 dark:text-gray-100 mt-1 block w-full" v-model="form.email" required />
                            ...
                            <div class="flex items-center gap-4">
                                <PrimaryButton type="submit" :disabled="form.processing">Create Team Member</PrimaryButton>
                                <Link :href="route('directory.index')" class="inline-flex items-center px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-500 rounded-md font-semibold text-xs text-gray-700 dark:text-gray-300 uppercase tracking-widest shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 disabled:opacity-25 transition ease-in-out duration-150">
                                    Cancel
                                </Link>
    ...
    <Modal :show="showImageActions" @close="showImageActions = false">
      <div class="p-6 dark:bg-gray-800">
        ...
        <div class="mt-6 flex flex-wrap gap-3 justify-end">
          ...
          <DangerButton type="button" @click.prevent="triggerDeleteImage" :disabled="!form.img">Delete</DangerButton>
