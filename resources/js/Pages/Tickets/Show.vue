                                        ...
                                        <div class="flex items-center gap-2">
                                            <div v-if="can.changeStatus" class="flex items-center gap-2">
                                                ...
                                                <select
                                                    ...
                                                    class="text-sm rounded-md border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 px-2 py-1 focus:outline-none focus:ring-2 focus:ring-uh-teal focus:border-uh-teal"
                                                >
                                                ...
                                                <button
                                                    ...
                                                    class="px-3 py-1 text-xs font-medium rounded-md text-white bg-uh-teal hover:bg-uh-green disabled:opacity-50 disabled:cursor-not-allowed"
                                            ...
                                            <Link
                                                ...
                                                class="p-2 rounded-md text-gray-600 dark:text-gray-300 hover:text-uh-teal hover:bg-uh-teal/10 focus:outline-none focus:ring-2 focus:ring-uh-teal"
